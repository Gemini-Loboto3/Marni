...
LONG Try640400Mode(LPCWSTR devname, DEVMODEW *mode, DWORD flags, BOOL *crop400)
{
	LONG error;
	DEVMODEW newmode = *mode;
	newmode.dmPelsHeight = 400;
	error = ChangeDisplaySettingsExW(devname, &newmode, NULL, flags, NULL);
	...
	return ChangeDisplaySettingsExW(devname, mode, NULL, flags, NULL);
}
