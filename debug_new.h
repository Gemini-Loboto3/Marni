...
extern char new_output_fp[1024];// default to stderr: output to console
...
#define DEBUG_GNEW __debug_new_recorder(__FILE__, __LINE__) ->* new
#else
#define DEBUG_GNEW new(__FILE__, __LINE__)
#endif
